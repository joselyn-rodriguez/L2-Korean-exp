...
class HeadphonesCheck {
  ...
  constructor(settings = {}) {
    this._settings = {
      ...
      checkSounds: [
        {answer: 1, file: 'HugginsPitch_set1_1.flac'},
        {answer: 2, file: 'HugginsPitch_set1_2.flac'},
        {answer: 3, file: 'HugginsPitch_set1_3.flac'},
        {answer: 1, file: 'HugginsPitch_set2_1.flac'},
        {answer: 2, file: 'HugginsPitch_set2_2.flac'},
        {answer: 3, file: 'HugginsPitch_set2_3.flac'},
        {answer: 1, file: 'HugginsPitch_set3_1.flac'},
        {answer: 2, file: 'HugginsPitch_set3_2.flac'},
        {answer: 3, file: 'HugginsPitch_set3_3.flac'},
        {answer: 1, file: 'HugginsPitch_set4_1.flac'},
        {answer: 2, file: 'HugginsPitch_set4_2.flac'},
        {answer: 3, file: 'HugginsPitch_set4_3.flac'},
        {answer: 1, file: 'HugginsPitch_set5_1.flac'},
        {answer: 2, file: 'HugginsPitch_set5_2.flac'},
        {answer: 3, file: 'HugginsPitch_set5_3.flac'},
        {answer: 1, file: 'HugginsPitch_set6_1.flac'},
        {answer: 2, file: 'HugginsPitch_set6_2.flac'},
        {answer: 3, file: 'HugginsPitch_set6_3.flac'},
      ],
      trialCount: 6,
      passMark: 6,
      maxAttempts: 2,
